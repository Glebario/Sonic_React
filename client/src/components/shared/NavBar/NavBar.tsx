    ...
    return (
      <div className="row">
        <div className="col-3">
          <div id="main-sidebar">
            <div className="logo">
              <NavLink to={`/user/${this.userModel.ownerUser.localId}`}><h1>Sonic</h1></NavLink>
              <span>Creative Portfolio Template</span>
            </div>
            <ul className="main-menu">
              <li className="home">
                <NavLink to={`/user/${this.userModel.ownerUser.localId}`} activeClassName="active-home">Home</NavLink>
              </li>
              <li className="users">
